...
public class APIUtilities {
    ...
    /**
     * This method is used to retrieve authorization token for specific role
     * from the server
     * Token must be attached to the header of every API call
     *
     * @return token
...
* */
    ...
    /**
     * use this method before creating your user
     * if user doesn't exist - this method will delete that user
     * @param email
     * @param password
     */
